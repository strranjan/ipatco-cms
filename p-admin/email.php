...
$config['smtp_host']        = siteInfo('email-server');
...
$config['smtp_user']        = siteInfo('email-login');
$config['smtp_pass']        = siteInfo('email-password');
$config['smtp_port']        = siteInfo('email-port');
