								...
								<div class="card-block">
									<form method="POST">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select size="1" class="form-control" id="user_role" name="user_role">
													<option value="121" <?=set_value('user_role') == '121'?'selected':'';?>>Admin</option>
													<option value="1" <?=set_value('user_role') == '1'?'selected':'';?>>User</option>
												</select>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<button type="submit" class="btn btn-info"><i class="icofont icofont-save"></i> Save User</button>
											</div>
										</div>
									</form>
								</div>
