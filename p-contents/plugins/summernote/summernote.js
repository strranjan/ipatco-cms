...
(function (factory) {
  ...
  var ui = {
    ...
    button: function ($node, options) {
      return renderer.create('<button type="button" class="note-btn btn btn-info btn-sm" tabindex="-1">', function ($node, options) {
          ...
          children: [
            ...
            ui.dropdown({
              items: [
                ...
                '  <div>',
                '    <button type="button" class="note-color-reset btn btn-info" data-event="backColor" data-value="inherit">',
                ...
                '  <div>',
                '    <button type="button" class="note-color-reset btn btn-info" data-event="removeFormat" data-value="foreColor">',
